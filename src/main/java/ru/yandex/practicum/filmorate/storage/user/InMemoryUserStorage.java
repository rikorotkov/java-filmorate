...
//        }
//
//        user.getFriends().add(Friendship.builder()
//                .user(user)
//                .friendId(friendId)
//                .isConfirmed(false)
...
//                .build());
//
//        friend.getFriends().add(Friendship.builder()
//                .user(friend)
//                .friendId(userId)
//                .isConfirmed(false)
//                .createdAt(LocalDateTime.now())
...
//        }
//
//        Set<Long> userFriends = user.getFriends().stream()
//                .map(Friendship::getFriendId)
//                .collect(Collectors.toSet());
//
//        Set<Long> friendFriends = friend.getFriends().stream()
//                .map(Friendship::getFriendId)
//                .collect(Collectors.toSet());
//
